                ...
                <form action="{{ route('admin.users.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <select id="role" name="role"
                            ...
                            <option value="ba" {{ old('role', $user->role) == 'ba' ? 'selected' : '' }}>Beauty Advisor
                                (BA)</option>
                    ...
                    <div id="distributor_group" class="mt-4 {{ old('role', $user->role) == 'admin' ? 'hidden' : '' }}">
                    ...
                    <div id="outlet_group" class="mt-4 {{ old('role', $user->role) == 'admin' ? 'hidden' : '' }}">
                    ...
                    @endphp
                    <div id="ba_fields" class="mt-8 border-t border-gray-200 dark:border-gray-700 pt-6 {{ old('role', $user->role) == 'admin' ? 'hidden' : '' }}">
