        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 shadow-xl shadow-gray-200/50 dark:shadow-none sm:rounded-2xl border border-gray-100 dark:border-gray-700 overflow-hidden">
                <div class="px-8 py-6 border-b border-gray-100 dark:border-gray-700">
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400">Daftar permohonan koreksi absensi Anda</p>
                </div>
                            ...
                            <tbody class="divide-y divide-gray-50 dark:divide-gray-700/50">
                                @forelse($requests as $request)
                                    <tr class="group hover:bg-gray-50/50 dark:hover:bg-gray-900/20 transition-all duration-300">
                                        ...
                                        <td class="py-5 px-6">
                                            <span class="inline-flex items-center px-2.5 py-1 rounded-md text-[10px] font-bold {{ $request->type === 'check-in' ? 'bg-blue-50 text-blue-700 border border-blue-100 dark:bg-blue-900/30 dark:text-blue-400' : 'bg-indigo-50 text-indigo-700 border border-indigo-100 dark:bg-indigo-900/30 dark:text-indigo-400' }} uppercase tracking-wider">
                                                {{ $request->type }}
                                            </span>
                                        </td>
                                        <td class="py-5 px-6">
